...
function make_order() {
    ...
    for(let i = 0 ; i < elements.length-1 ; i++) {
        ...
        let text_pp = document.createElement("div");
        var text_p = document.createElement('input');
        text_p.setAttribute("type", "text");
        text_p.className = "item";
        text_p.id = "item" + i;
        text_p.name = 'item' + i;
        text_p.style.height = 32 + "px";
        text_p.style.textAlign = "left";
        text_p.style.backgroundColor = 'transparent';
        // let text = document.createTextNode(elements[i]);
        // console.log(text);
        // text_p.appendChild(text);
        text_p.value = elements[i];
        text_p.readOnly = true;
        text_p.style.color = 'azure';

        let center1 = document.createElement("center");
        center1.appendChild(text_pp);
        text_pp.appendChild(text_p);
